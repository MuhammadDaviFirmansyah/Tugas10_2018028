...
import com.example.pertemuan3.databinding.ActivityInputGameBinding;
...
public class InputGame extends AppCompatActivity {
    private ActivityInputGameBinding binding;
    DBmain dBmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInputGameBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(InputGame.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    binding.edtname.setText("");
                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(InputGame.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InputGame.this,
                        DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(InputGame.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(InputGame.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
